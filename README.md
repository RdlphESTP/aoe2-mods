...
> [!IMPORTANT] Looking for The Conquerors?
...
> [!TIP] Game won't launch on a modern PC?
...
> [!NOTE] Drag Scroll (`dragscroll.dll`)
...
- **Camera coordinates (isometric grid)**: `+0x168` (i), `+0x16C` (j)
